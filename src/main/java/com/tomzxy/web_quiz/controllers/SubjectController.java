...
public class SubjectController {
    ...
    @GetMapping()
    public DataResDTO<PageResDTO<?>> getAllSubject(@RequestParam @Min(0) int page ,@RequestParam @Min(10) int size){
        log.info("Get all Subjects");
        return DataResDTO.ok(subjectService.get_Subjects_pageable(page,size));
    }
